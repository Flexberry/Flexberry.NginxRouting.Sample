...
namespace IIS.NginxSample
{
    ...
    public class Car : ICSSoft.STORMNET.DataObject, IDataObjectWithAuditFields
    {
        ...
        private IIS.NginxSample.CarType fCarBody;

        private System.DateTime fCarDate;

        private IIS.NginxSample.Brand fBrand;

        private IIS.NginxSample.DetailArrayOfSparePart fSparePart;
        ...
        public virtual IIS.NginxSample.CarType CarBody
        {
            get
            {
                ...
                IIS.NginxSample.CarType result = this.fCarBody;
        ...
        [NotNull()]
        public virtual IIS.NginxSample.Brand Brand
        {
            get
            {
                ...
                IIS.NginxSample.Brand result = this.fBrand;
        ...
        public virtual IIS.NginxSample.DetailArrayOfSparePart SparePart
        {
            get
            {
                ...
                {
                    this.fSparePart = new IIS.NginxSample.DetailArrayOfSparePart(this);
                }
                IIS.NginxSample.DetailArrayOfSparePart result = this.fSparePart;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View AuditView
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("AuditView", typeof(IIS.NginxSample.Car));
                }
            }
            ...
            public static ICSSoft.STORMNET.View CarE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CarE", typeof(IIS.NginxSample.Car));
                }
            }
            ...
            public static ICSSoft.STORMNET.View CarL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CarL", typeof(IIS.NginxSample.Car));
                }
            }
        }
