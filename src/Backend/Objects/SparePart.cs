...
namespace IIS.NginxSample
{
    ...
    public class SparePart : ICSSoft.STORMNET.DataObject, IDataObjectWithAuditFields
    {
        ...
        private IIS.NginxSample.ProducingCountry fProducingCountry;
        
        private IIS.NginxSample.Car fCar;
        ...
        public virtual IIS.NginxSample.ProducingCountry ProducingCountry
        {
            get
            {
                ...
                IIS.NginxSample.ProducingCountry result = this.fProducingCountry;
        ...
        /// <summary>
        /// Мастеровая ссылка на шапку Car.
        /// </summary>
        ...
        [Agregator()]
        [NotNull()]
        public virtual IIS.NginxSample.Car Car
        {
            get
            {
                ...
                IIS.NginxSample.Car result = this.fCar;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View AuditView
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("AuditView", typeof(IIS.NginxSample.SparePart));
                }
            }
            ...
            public static ICSSoft.STORMNET.View SparePartE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("SparePartE", typeof(IIS.NginxSample.SparePart));
                }
            }
        }
    ...
    public class DetailArrayOfSparePart : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.NginxSample.DetailArrayOfSparePart members)

        // *** End programmer edit section *** (IIS.NginxSample.DetailArrayOfSparePart members)
        ...
        /// </summary>
        public DetailArrayOfSparePart(IIS.NginxSample.Car fCar) : 
                base(typeof(SparePart), ((ICSSoft.STORMNET.DataObject)(fCar)))
        {
        }
        
        public IIS.NginxSample.SparePart this[int index]
        {
            get
            {
                return ((IIS.NginxSample.SparePart)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.NginxSample.SparePart dataobject)
        {
