...
namespace IIS.NginxSample
{
    ...
    [View("BrandL", new string[] {
            ...
            "EditTime",
            "Editor"})]
    public class Brand : ICSSoft.STORMNET.DataObject, IDataObjectWithAuditFields
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View BrandE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("BrandE", typeof(IIS.NginxSample.Brand));
                }
            }
            ...
            public static ICSSoft.STORMNET.View BrandL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("BrandL", typeof(IIS.NginxSample.Brand));
                }
            }
        }
