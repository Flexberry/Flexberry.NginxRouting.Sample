...
moduleForAcceptance('[AGAT] Acceptance | i i s ni fi sample producing country l');

test('testing i-i-s-nginx-sample-producing-country-l', function(assert) {
  visit('/i-i-s-nginx-sample-producing-country-l');
