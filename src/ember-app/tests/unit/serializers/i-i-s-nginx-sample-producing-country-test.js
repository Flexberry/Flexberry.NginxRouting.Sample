...
moduleForModel('i-i-s-nginx-sample-producing-country', 'Unit | Serializer | i-i-s-nginx-sample-producing-country', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-nginx-sample-producing-country',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
